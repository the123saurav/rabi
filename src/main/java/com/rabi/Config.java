...
public final class Config implements Cloneable {
  ...
  private Config(long memMax, short parallelism, short memtableSegments, boolean sync,
  ...
  public static final class ConfigBuilder {
    ...
    private static final String MEMTABLE_MAX_KEYS_ERR_STRING =
        "memtableMaxKeys should be atleast " + MEMTABLE_MINIMUM_MAX_KEYS;
    private static final String MEMTABLE_MAX_SEGMENTS_ERR_STRING =
        "memtableMaxSegments should be less than " + MAX_MEMTABLE_SEGMENTS;
